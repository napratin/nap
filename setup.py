...
pkg_name = 'nap'  # top-level package name
scripts_dir = os.path.join(pkg_name, 'scripts')  # useful executable scripts
...
setup(
  name=pkg_name,
  version='0.1',
  description='Neurocognitive Action-Perception: A neuronal architecture for visual perception and embodied action.',
  long_description=readme,
  url='https://github.com/napratin/nap',
